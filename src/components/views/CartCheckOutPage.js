<<<<<<< HEAD:day-5-contact-us-page-start/src/components/views/CartCheckOutPage.js
    ...
    return (
        <div>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                {productsInCart.length === 0 && <h1>No items in cart</h1>}
=======
import React from 'react';
...
>>>>>>> 481e7b92c74c63676514857755476a21f54be89c:src/components/views/CartCheckOutPage.js
            </div>
        </div>
    );
};
